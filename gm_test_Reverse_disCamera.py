...
class test_Reverse_disCamera(tlib.TestExec):
...
def test_package(): 
    ...
    usecase_gearPark_dfeault.testname = "usecase_gear_Park2Reverse_disable_Camera"
    ...
    test_Reverse_disCamera(usecase_gearPark_dfeault)
