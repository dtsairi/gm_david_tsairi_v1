...
class test_DriveToReverse_defaultCheck(tlib.TestExec):
...
def test_package(): 
    ...
    usecase_gearPark_dfeault.testname = "usecase_gear_Drive2Reverse"
    ...
    test_DriveToReverse_defaultCheck(usecase_gearPark_dfeault)
