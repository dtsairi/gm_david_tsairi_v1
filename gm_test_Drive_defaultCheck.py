...
class test_Drive_defaultCheck(tlib.TestExec):
    ...
    def run(self):  
        try:
            ...
            if  self.pc.display.get_Display() != self.pc.display.CarInfo:
                self.set_testFail()
...
def test_package(): 
    ...
    usecase_defualt = tlib.test()   
    usecase_defualt.testname = "usecase_gear_Drive_dfeault"
    usecase_defualt.settings["Temp"] = gVars.const.AMBIANT_TEMP
    usecase_defualt.settings["IsDay"] = False
    usecase_defualt.cycles = 1        
    test_Drive_defaultCheck(usecase_defualt)
    ...
    usecase_defualt.testname = "usecase_gear_Drive_dfeault"
    usecase_defualt.settings["Temp"] = gVars.const.AMBIANT_TEMP
    usecase_defualt.settings["IsDay"] = True
    usecase_defualt.cycles = 1    
    test_Drive_defaultCheck(usecase_defualt)   
    ...
    usecase_defualt = tlib.test()   
    usecase_defualt.testname = "usecase_gear_Drive_dfeault"
    usecase_defualt.settings["Temp"] = gVars.const.HIGH_TEMP
    usecase_defualt.settings["IsDay"] = False
    usecase_defualt.cycles = 1         
    test_Drive_defaultCheck(usecase_defualt)    
